...
\author{\normalsize Justin Gallagher (jgallagher@cmu.edu)\vspace*{.4em}\\\normalsize Ted Li (wenxuanl@andrew.cmu.edu)}
\clearpage\maketitle
...
ExplainShell for Chrome allieviates this problem by showing the user a popup window with a detailed explaination of commands found online. Utilizing information from explainshell.com, another open source project the extension will prevent users from copy and pasting to another page, a barrier which might cause users to run commands without checking their function. This project will provide a useful product and allow us to explore Chrome extension development as well as learn how to interact with other open source projects.
